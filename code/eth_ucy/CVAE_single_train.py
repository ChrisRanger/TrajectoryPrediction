        ...
        for epoch_i in range(epochs):
            ...
            for _ in progress_bar:
                ...
                if i % checkpoint_steps == 0:
                    ...
                    #               "epoch": epoch_i}
                    # path_checkpoint = "../../model/cvae/checkpoint_{}_epoch.pkl".format(epoch_i)
            ...
            if epoch_i % valid_steps == 0:
                ...
                for j in valid_progress_bar:
                    ...
                    valid_ade = utils._average_displacement_error(targets_valid, pred, conf, mode='best')
                ...
                print('eval phase: epoch: %5d' % epoch_i, 'i: %5d' % i,
                      'loss(avg): %10.5f' % mean_loss_valid,
                      'ade(avg): %10.5f' % mean_ade_valid,
