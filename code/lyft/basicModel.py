...
class Context_Encoder(nn.Module):
    def __init__(self, cfg: Dict, cont_dim=256):
        super().__init__()
...
class Singel_Decoder(nn.Module):
    def __init__(
        self, cfg: Dict, embedding_dim=64, h_dim=128, mlp_dim=1024, num_layers=1,
        dropout=0.0, activation='relu', batch_norm=True
    ):
        super(Singel_Decoder, self).__init__()
        self.pred_len = cfg["model_params"]["future_num_frames"]
